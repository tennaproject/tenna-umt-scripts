...
void TennaExportConsumables()
{
  if (!TennaExportConsumables(TennaSelectExportDir()))
    throw new Exception("DataExportConsumables.csx failed.");
}

bool TennaExportConsumables(string exportDir)
{
  return TennaExportExactNameTable("consumable", "DataExportConsumables.csx", "consumables.json", "ITEM", "scr_itemnamelist", "case", "global.itemname", exportDir);
}
